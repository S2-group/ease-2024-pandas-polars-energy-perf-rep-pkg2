...
correlation_cpu_Pandas_Big <- cor.test(Pandas_Data_Big$energy_usage, Pandas_Data_Big$cpu_usage, method = "spearman",conf.level = 0.95)
correlation_mem_Pandas_Big <- cor.test(Pandas_Data_Big$energy_usage, Pandas_Data_Big$memory_usage, method = "spearman",conf.level = 0.95)
correlation_exe_Pandas_Big <- cor.test(Pandas_Data_Big$energy_usage, Pandas_Data_Big$execution_time, method = "spearman",conf.level = 0.95)
correlation_cpu_Pandas_Small <- cor.test(Pandas_Data_Small$energy_usage, Pandas_Data_Small$cpu_usage, method = "spearman",conf.level = 0.95)
correlation_mem_Pandas_Small <- cor.test(Pandas_Data_Small$energy_usage, Pandas_Data_Small$memory_usage, method = "spearman",conf.level = 0.95)
correlation_exe_Pandas_Small <- cor.test(Pandas_Data_Small$energy_usage, Pandas_Data_Small$execution_time, method = "spearman",conf.level = 0.95)
correlation_cpu_Polars_Big <- cor.test(Polars_Data_Big$energy_usage, Polars_Data_Big$cpu_usage, method = "spearman",conf.level = 0.95)
correlation_mem_Polars_Big <- cor.test(Polars_Data_Big$energy_usage, Polars_Data_Big$memory_usage, method = "spearman",conf.level = 0.95)
correlation_exe_Polars_Big <- cor.test(Polars_Data_Big$energy_usage, Polars_Data_Big$execution_time, method = "spearman",conf.level = 0.95)
correlation_cpu_Polars_Small <- cor.test(Polars_Data_Small$energy_usage, Polars_Data_Small$cpu_usage, method = "spearman",conf.level = 0.95)
correlation_mem_Polars_Small <- cor.test(Polars_Data_Small$energy_usage, Polars_Data_Small$memory_usage, method = "spearman",conf.level = 0.95)
correlation_exe_Polars_Small <- cor.test(Polars_Data_Small$energy_usage, Polars_Data_Small$execution_time, method = "spearman",conf.level = 0.95)
...
library(knitr)
print( correlation_cpu_Pandas_Small$conf.int)
...
results_df <- data.frame(
  ...
  Confidence = c(
    correlation_cpu_Pandas_Small$conf.int,
    correlation_mem_Pandas_Small$conf.int,
    correlation_exe_Pandas_Small$conf.int,
    correlation_cpu_Pandas_Big$conf.int,
    correlation_mem_Pandas_Big$conf.int,
    correlation_exe_Pandas_Big$conf.int,
    correlation_cpu_Polars_Small$conf.int,
    correlation_mem_Polars_Small$conf.int,
    correlation_exe_Polars_Small$conf.int,
    correlation_cpu_Polars_Big$conf.int,
    correlation_mem_Polars_Big$conf.int,
    correlation_exe_Polars_Big$conf.int
  )
)
