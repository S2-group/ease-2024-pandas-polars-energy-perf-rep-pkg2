...
scatter_plot_cpu_Polars_Big <- make_scatter_plot_with_correlation_blue(Polars_Data_Big, "energy_usage", "cpu_usage", "Scatterplot: Energy Usage vs. CPU Usage (Polars Big Dataset)")
scatter_plot_mem_Polars_Big <- make_scatter_plot_with_correlation_blue(Polars_Data_Big, "energy_usage", "memory_usage", "Scatterplot: Energy Usage vs. Memory Usage (Polars Big Dataset)")
scatter_plot_exe_Polars_Big <- make_scatter_plot_with_correlation_blue(Polars_Data_Big, "energy_usage", "execution_time", "Scatterplot: Energy Usage vs. Execution Time (Polars Big Dataset)")

# Create scatter plots with correlation line and blue color
scatter_plot_cpu_Polars_Small <- make_scatter_plot_with_correlation_blue(Polars_Data_Small, "energy_usage", "cpu_usage", "Scatterplot: Energy Usage vs. CPU Usage (Polars Small Dataset)")
scatter_plot_mem_Polars_Small <- make_scatter_plot_with_correlation_blue(Polars_Data_Small, "energy_usage", "memory_usage", "Scatterplot: Energy Usage vs. Memory Usage (Polars Small Dataset)")
scatter_plot_exe_Polars_Small <- make_scatter_plot_with_correlation_blue(Polars_Data_Small, "energy_usage", "execution_time", "Scatterplot: Energy Usage vs. Execution Time (Polars Small Dataset)")

# Create scatter plots with correlation line and blue color
scatter_plot_cpu_Pandas_Big <- make_scatter_plot_with_correlation(Pandas_Data_Big, "energy_usage", "cpu_usage", "Scatterplot: Energy Usage vs. CPU Usage (Pandas Big Dataset)")
scatter_plot_mem_Pandas_Big <- make_scatter_plot_with_correlation(Pandas_Data_Big, "energy_usage", "memory_usage", "Scatterplot: Energy Usage vs. Memory Usage (Pandas Big Dataset)")
scatter_plot_exe_Pandas_Big <- make_scatter_plot_with_correlation(Pandas_Data_Big, "energy_usage", "execution_time", "Scatterplot: Energy Usage vs. Execution Time (Pandas Big Dataset)")

# Create scatter plots with correlation line and blue color
scatter_plot_cpu_Pandas_Small <- make_scatter_plot_with_correlation(Pandas_Data_Small, "energy_usage", "cpu_usage", "Scatterplot: Energy Usage vs. CPU Usage (Pandas Small Dataset)")
scatter_plot_mem_Pandas_Small <- make_scatter_plot_with_correlation(Pandas_Data_Small, "energy_usage", "memory_usage", "Scatterplot: Energy Usage vs. Memory Usage (Pandas Small Dataset)")
scatter_plot_exe_Pandas_Small <- make_scatter_plot_with_correlation(Pandas_Data_Small, "energy_usage", "execution_time", "Scatterplot: Energy Usage vs. Execution Time (Pandas Small Dataset)")
